...
-- 2026-03-16: Fix mark_meal_eaten shopping_list insert for new schema
-- The shopping_list table now uses ingredient_name (text) + is_checked instead
-- of ingredient_id/product_id. Update the function to insert using the new
-- columns and avoid duplicates via an existence check.
